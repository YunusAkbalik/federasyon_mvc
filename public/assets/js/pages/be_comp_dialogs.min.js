...
Dashmix.onLoad((() => class {
    static sweetAlert2() {
        ...
        document.querySelector(".js-swal-simple").addEventListener(
            "click", (t => {
        ...
        })), document.querySelector(".js-swal-custom-position").addEventListener("click", (t => { e.fire({ position: "top-end", title: "Perfect!", text: "Nice Position!", icon: "success" }) }))


    }
    static init() { this.sweetAlert2() }
}.init()));