...
<head>
    ...
    <!-- Open Graph Meta -->
    <meta property="og:title" content="Öğrenci Kayıt">
    <meta property="og:site_name" content="MNG Dijital">
    <meta property="og:description" content="Öğrenci Kayıt">
...
<body>
                            ...
                            <div
                                ...
                                <div class="mb-2 text-center">
                                    <a class="link-fx fw-bold fs-1" href="index.html">
                                        <span class="text-dark">Öğrenci</span><span class="text-primary">kayıt</span>
                                    </a>
                                    <p class="text-uppercase fw-bold fs-sm text-muted">YENİ BİR ÖĞRENCİ HESABI OLUŞTUR
                                    </p>
                                </div>
                                <!-- END Header -->
                                ...
                                <form class="js-validation-signup" action="{{ route('ogrenci_kayit_post') }}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <div class="row">
                                    ...
                                    <div class="mb-4">
                                        <div class="input-group input-group-lg">
                                            <input type="tel" class="form-control" id="kan_grubu"
                                                name="kan_grubu" placeholder="Kan grubu Örn: (0 RH +)">
                                            <span class="input-group-text">
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 mb-4">
                                            <div class="input-group input-group-lg">
                                                <select name="il" onchange="ilSelect(this.value)"
                                                    class="form-control" id="il">
                                        ...
                                        <div class="col-xxl-6 mb-4">
                                            <div class="input-group input-group-lg">
                                                <select name="ilce" onchange="ilceSelect(this.value)"
                                                    class="form-control" id="ilce">
    ...
    <script src="{{ asset('assets/js/pages/ogrenci_kayit.js') }}"></script>
