    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Ders Planı Düzenle</h1>
            ...
            <div class="block-content">
                <div class="row justify-content-center">
                    <div class="col xxl-8 col-xl-10 col-lg-12">
                        <form action="{{ route('kurum_dersPlani_update') }}" method="POST" class="dersPlani"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-floating">
                                        <select name="ders_id" class="form-control" id="ders_id">
                                            @foreach ($dersler as $ders)
                                                <option {{ $dersplani->ders_id == $ders->id ? 'selected' : '' }}
                                                    value="{{ $ders->id }}">{{ $ders->ad }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 mb-4">
                                    <select class="js-select2 form-select" id="siniflar[]" name="siniflar[]"
                                        ...
                                        <option></option>
                                        @for ($i = 1; $i < 13; $i++)
                                            <option {{ in_array($i, $siniflar) ? 'selected' : '' }}
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="ogrenci_sayisi" name="ogrenci_sayisi"
                                            ...
                                            value="{{ $dersplani->ogrenci_sayisi }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="sure" name="sure"
                                            placeholder="Süre" value="{{ $dersplani->sure }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="konu" name="konu"
                                            placeholder="Konu" value="{{ $dersplani->konu }}">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="kazanimlar" id="kazanimlar" cols="30" rows="10">{{ $dersplani->kazanimlar }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="arac_gerec" class="form-label">Kullanılan Araç Gereçler</label>
                                    <textarea name="arac_gerec" id="arac_gerec" cols="30" rows="10">{{ $dersplani->arac_gerec }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <label for="dersin_islenisi" class="form-label">Dersin İşlenişi <span
                                            class="text-danger">(*)</span></label>
                                    <textarea name="dersin_islenisi" id="dersin_islenisi" cols="30" rows="10">{{ $dersplani->dersin_islenisi }}</textarea>
                                </div>
                                <input type="hidden" name="dersplaniID" value="{{ $dersplani->id }}">
                                <div class="col-12 mb-4">
                                    <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Ders Planını
                                        Güncelle</button>
                                </div>
                            </div>
                        </form>
