 ...
 <script>
     function getData(id) {
         ...
         fd.append('id', id);
         $.ajax({
             url: '{{ route('admin_show_ogretmen_bekleyen') }}',
             method: 'post',
             data: fd,
             processData: false,
             contentType: false,
             success: function(res) {
                 var buttons = ` <button type="button" class="btn btn-sm btn-success" onclick="onayla(${id})"
                         data-bs-dismiss="modal">Onayla</button>
                     <button type="button" class="btn btn-sm btn-danger" onclick="reddet_alert(${id})">Reddet</button>
                     <button type="button" class="btn btn-sm btn-alt-secondary" data-bs-dismiss="modal">Kapat</button>`
     ...
     function onayla(id) {
         ...
         fd.append('id', id);
         $.ajax({
             url: '{{ route('admin_onayla_ogretmen') }}',
             method: 'post',
             data: fd,
             processData: false,
             contentType: false,
     ...
     function reddet(id, neden) {
         var fd = new FormData();
         fd.append('_token', $('input[name="_token"]').val());
         fd.append('id', id);
         fd.append('ret_nedeni', neden);
         $.ajax({
             url: '{{ route('admin_reddet_ogretmen') }}',
             method: 'post',
             data: fd,
             processData: false,
             contentType: false,
     ...
     function reddet_alert(id) {
         let neden = prompt("Reddetme nedeni");
         if (neden == null || neden == "") {
