            ...
            <div class="block-content">
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-xl-6">
                        <form class="js-validation-signup" action="{{ route('admin_create_acc_ogrenci_post') }}" method="POST">
                            @csrf
...
@section('js')
    ...
    <script src="{{ asset('assets/js/pages/admin_create_acc_ogrenci.js') }}"></script>
    <script>
