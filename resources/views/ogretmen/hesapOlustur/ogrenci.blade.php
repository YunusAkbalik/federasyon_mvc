            ...
            <div class="block-content">
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-xl-6">
                        <form class="js-validation-signup" action="{{ route('ogretmen_hesapOlustur_ogrenci_post') }}"
                            method="POST">
                            @csrf
...
@section('js')
    ...
    <script>
        ...
        function okulSelect(id, sinifsec = 0) {
            ...
            $.ajax({
                url: "{{ route('ogretmen_get_sinif_from_okul') }}",
                method: 'post',
                data: fd,
                processData: false,
                contentType: false,
        ...
        function getIlIlce(okul_id) {
            ...
            $.ajax({
                url: '{{ route('ogretmen_get_ililce_from_okul') }}',
                method: 'post',
                data: fd,
                processData: false,
                contentType: false,
