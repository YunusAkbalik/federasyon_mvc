...
<head>
    ...
    <meta name="description" content="Öğretmen Kayıt">
    <meta name="author" content="roosecs">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="Öğretmen Kayıt">
    <meta property="og:site_name" content="MNG Dijital">
    <meta property="og:description" content="Öğretmen Kayıt">
...
<body>
                            ...
                            <div
                                ...
                                <div class="mb-2 text-center">
                                    <a class="link-fx fw-bold fs-1" href="index.html">
                                        <span class="text-dark">Öğretmen</span><span class="text-primary">kayıt</span>
                                    </a>
                                    <p class="text-uppercase fw-bold fs-sm text-muted">YENİ BİR ÖĞRETMEN HESABI OLUŞTUR
                                    </p>
                                </div>
                                <!-- END Header -->
                                ...
                                <form class="js-validation-signup" enctype="multipart/form-data"
                                    action="{{ route('ogretmen_kayit_post') }}" method="POST">
                                    @csrf
                                    <div class="mb-4">
                                        <div class="row">
    ...
    <script src="{{ asset('assets/js/pages/ogretmen_kayit.js') }}"></script>
